...
public class CircleImageView extends AppCompatImageView {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        //  展示类型
        styleType = ta.getInt(R.styleable.CircleImageView_sScaleType, TOP);
        //  描边
        ...
        //  不常用属性
        topLeftRadius_x = ta.getDimension(R.styleable.CircleImageView_topLeftRadius_x, 0);
        topLeftRadius_y = ta.getDimension(R.styleable.CircleImageView_topLeftRadius_y, 0);
        topRightRadius_x = ta.getDimension(R.styleable.CircleImageView_topRightRadius_x, 0);
        topRightRadius_y = ta.getDimension(R.styleable.CircleImageView_topRightRadius_y, 0);
        bottomLeftRadius_x = ta.getDimension(R.styleable.CircleImageView_bottomLeftRadius_x, 0);
        bottomLeftRadius_y = ta.getDimension(R.styleable.CircleImageView_bottomLeftRadius_y, 0);
        bottomRightRadius_x = ta.getDimension(R.styleable.CircleImageView_bottomRightRadius_x, 0);
        bottomRightRadius_y = ta.getDimension(R.styleable.CircleImageView_bottomRightRadius_y, 0);
