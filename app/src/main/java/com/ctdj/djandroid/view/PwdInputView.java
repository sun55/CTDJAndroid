...
public class PwdInputView extends AppCompatEditText {
    private static final String TAG = "PwdInputView";
...
//        xfermode = new PorterDuffXfermode(PorterDuff.Mode.SRC_OUT);
    ...
    private void initAttribute(Context context, AttributeSet attrs) {
        ...
        strokeWidth = t.getDimensionPixelSize(R.styleable.PwdInputView_pwv_strokeWidth, 2);
    ...
    private void checkRadius(int availableWidth, int availableHeight) {
        ...
        if (radius > availableRadius) {
            LogUtil.d("radius is too large, reset it");
    ...
    private void checkSpacing(int availableWidth) {
        if (spacing < 0 || (maxLength - 1) * spacing >= availableWidth) {
            LogUtil.d("spacing is too large, reset it to zero");
            spacing = 0;
        }
    }
