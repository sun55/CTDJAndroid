...
//        mLightColor = ContextCompat.getColor(mContext, Color.parseColor("#EBEBED"));
//        mDarkColor = ContextCompat.getColor(mContext, Color.parseColor("#80EBEBED"));
        mLightColor = Color.parseColor("#FFEBEBED");
        mDarkColor = Color.parseColor("#80EBEBED");
    }
